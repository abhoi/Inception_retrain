...
Top layer receives as input a 2048-dimensional vector for each image. We 
train a softmax layer on top of this representation. Assuming the softmax layer
contains N labels, this corresponds to learning N + 2048*N model parameters
corresponding to the learned biases and weights.

# RUN DOCKER with portforwarding, loading tf_files, and loading tensorflow latest version
docker run -p 0.0.0.0:6006:6006 -it -v $HOME/tf_files:/tf_files  gcr.io/tensorflow/tensorflow:latest-devel

# RUN RETRAINING OF INCEPTION USING CALTECH101 DATASET, batch size 32, steps 1500
python /tensorflow/tensorflow/examples/image_retraining/retrain2.py \
...
--image_dir /tf_files/caltech_100 \
--summaries_dir /tmp/retrain_logs/run

# CLASSIFY IMAGES
python /tf_files/label_image.py --img-directory

# RUN TENSORBOARD DAEMON
...
# If you have a small dataset, to increase variation, you can flip images, crop, scale up, or mul
...
# Parameters tied to Inception v3
...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
  ...
  for sub_dir in sub_dirs:
    ...
    for file_name in file_list:
      ...
      # We need to decide whether this file should
